...
export default function StockTicker({ stocks }: { stocks: TickerItem[] }) {
  ...
  return (
    <div className="overflow-hidden border-b border-[#0ff2]/10 bg-[#050d12]/80 backdrop-blur-sm">
      <div
        ref={ref}
      ...
      >
        {items.map((s, i) => (
          <span key={i} className="inline-flex items-center gap-2 px-6 py-2 text-xs font-mono">
